...
const P = 'We all live in a yellow submarine yellow submarine, yellow submarine We all live in a yellow submarine yellow submarine, yellow submarine, yellow submarine, We all live in a yellow submarine yellow submarine, yellow submarine We all live in a yellow submarine yellow submarine, yellow submarine, yellow submarine'

// Encrypt the message with AES-128-ECB
const cipher = crypto.createCipheriv('aes-128-ecb', key128, null);
...
// Output encrypted text
const decrypted = decipherFn('aes-128-ecb', key128, null, encrypted);
...
//Removing one block in array position 3
const droppedBlock = encrypted16BytesArray.splice(3, 1);
const droppedCipher = encrypted16BytesArray.join('');

// //Output ciphertext after simulated dropped blocks
const decryptAfterDropping = decipherFn('aes-128-ecb', key128, null, droppedCipher);

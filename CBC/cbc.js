...
const cipher = crypto.createCipheriv('aes-128-cbc', key128, iv);
...
// Output encrypted text
const decrypted = decipherFn('aes-128-cbc', key128, iv, encrypted);
...
const decryptAfterDropping = decipherFn('aes-128-cbc', key128, iv, droppedCipher);
...
// Compare plaintext message with dropped ciphertext S

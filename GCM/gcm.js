...
const cipher = crypto.createCipheriv('aes-128-gcm', key128, iv);
...
// Output encrypted text
const decrypted = decipherFn('aes-128-gcm',key128,iv,encrypted);
...
const droppedBlock = encrypted16BytesArray.splice(0,0);
const droppedCipher = encrypted16BytesArray.join('');

// //Output ciphertext after simulated dropped blocks
const decryptAfterDropping = decipherFn('aes-128-gcm',key128,iv,droppedCipher);
